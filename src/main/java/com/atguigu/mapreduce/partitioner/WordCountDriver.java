...
public class WordCountDriver {
    public static void main(String[] args) throws IOException, InterruptedException, ClassNotFoundException {
        ...
        // 设置reduce个数，结果会产生两个reduce文件part-r-00000/part-r-00001，结果在两个文件中
        // 进入哪个分区，和key的hashCode与分区数取余的结果有关
        ...
        FileOutputFormat.setOutputPath(job, new Path("F:\\BaiduNetdiskDownload\\尚硅谷大数据技术之Hadoop3.x\\资料\\资料\\output\\output0224_2"));
